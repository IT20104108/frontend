...
onSubmit = (e) =>{
  ...
  axios.put(`https://afbackend.herokuapp.com/createmarking/update/${createmarkingID}`,data).then((res) =>{
  if(res.data.success){
...
componentDidMount(){
  ...
  axios.get(`https://afbackend.herokuapp.com/createmarking/${createmarkingID }`).then((res)=>{
  if (res.data.success){
  this.setState({
