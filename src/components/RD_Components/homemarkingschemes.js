...
//data retrive
 retrievecreatemarking(){
        axios.get("https://afbackend.herokuapp.com/createmarking/displaycreatemarking").then(res=>{
            if(res.data.success){
               this.setState({
...
onDelete = (createmarkingID) => {
  if (window.confirm('Are you sure you wish to delete this details?')) {
    axios.delete(`https://afbackend.herokuapp.com/createmarking/delete/${createmarkingID}`).then((res) => {
