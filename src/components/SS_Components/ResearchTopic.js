...
//Accept research topics 
    acceptTopic(id){
       console.log(id);
        axios.post(`https://afbackend.herokuapp.com/group/accepttopic/${id}/Accepted`).then(res=>{
...
//Reject research topics
    rejectTopic(id){
        console.log(id);
     axios.post(`https://afbackend.herokuapp.com/group/accepttopic/${id}/Rejected`).then(res=>{
