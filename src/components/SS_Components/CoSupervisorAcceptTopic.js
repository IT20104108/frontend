...
filterData(studentgroups,searchKey){
  ...
  handleSearchArea = (e)=>{
    ...
    axios.get("https://afbackend.herokuapp.com/student/displaygroups").then(res=>{
       if(res.data.success){
...
//Accept co supervisor request topics 
    acceptTopic(id){
       console.log(id);
        axios.post(`https://afbackend.herokuapp.com/group/requestcosupervisor/${id}/Accepted`).then(res=>{
...
//Reject co supervisor request topics
    rejectTopic(id){
        console.log(id);
     axios.post(`https://afbackend.herokuapp.com/group/requestcosupervisor/${id}/Rejected`).then(res=>{
