...
//Accept supervisor request topics 
    acceptTopic(id){
       console.log(id);
        axios.post(`https://afbackend.herokuapp.com/group/requestsupervisor/${id}/Accepted`).then(res=>{
...
//Reject supervisor request topics
    rejectTopic(id){
        console.log(id);
     axios.post(`https://afbackend.herokuapp.com/group/requestsupervisor/${id}/Rejected`).then(res=>{
