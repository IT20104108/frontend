...
export default class Add_co_supervisor extends Component{
  ...
  async componentDidMount(){
       ...
       await axios.get(`https://afbackend.herokuapp.com/regtopic/getcosupervisor/${feild}`).then((res)=>{
       if(res.data.success){
               this.setState({
   ...
   onSubmit = (e)=>{
       ...
       const data = {
         ...
         axios.post(`https://afbackend.herokuapp.com/regtopic/addcoSupervisor/${id}`,data).then((res)=>{ 
