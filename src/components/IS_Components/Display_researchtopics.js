...
export default class Display_researchtopics extends Component{
   ...
   onReadirect(id){
    ...
    handleSearchArea = (e)=>{
        ...
        axios.get("https://afbackend.herokuapp.com/regtopic/displaysupervisors").then(res=>{
        if(res.data.success){
   ...
   retrieveResearchTopics(){
       axios.get("https://afbackend.herokuapp.com/regtopic/displayresearchtopic").then(res=>{
