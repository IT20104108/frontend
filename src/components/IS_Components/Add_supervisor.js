...
export default class Add_supervisor extends Component{
  ...
  async componentDidMount(){
    ...
    const id = this.props.match.params.id
       ...
       await axios.get(`https://afbackend.herokuapp.com/regtopic/getsupervisor/${feild}`).then((res)=>{
   ...
   onSubmit = (e)=>{
       ...
       axios.post(`https://afbackend.herokuapp.com/regtopic/addSupervisor/${id}`,data).then((res)=>{ 
