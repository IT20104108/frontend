...
export default class Add_research_topic extends Component{
  ...
  async componentDidMount(){
       ...
       await axios.get(`https://afbackend.herokuapp.com/student/display/${id}`).then((res)=>{
   ...
   onSubmit = (e)=>{
      ...
      const topicinfo = {
       ...
       axios.post(`https://afbackend.herokuapp.com/regtopic/research/${id}`,topicinfo).then((res)=>{ 
